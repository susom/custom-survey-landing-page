                        ...
                        waitForElement('#longurl', function() {
                            ...
                            function getUrlDiv(url, id, name) {
                                ...
                                $d= '<!-- ' + name +' -->' +
                                    ...
                                    '</div>' +
                                    '<div class="clear"></div>' + 
                                    '<div class="mt-3 alert alert-info" style="font-size:13px;border-color: #bee5eb !important;"><i class="fas fa-info-circle"></i> This URL has been generated by Custom Survey Landing Page External Module.</div>';
